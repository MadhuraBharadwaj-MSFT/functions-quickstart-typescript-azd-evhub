...
var storageEndpointConfig = {
  enableBlob: true  // Required for AzureWebJobsStorage, .zip deployment, Event Hubs trigger checkpointing
  enableQueue: false  // Required for Durable Functions and MCP trigger
  enableTable: true  // Required for Event Hubs trigger checkpointing
...
output INPUT_EVENTHUB_NAME string = 'input-events'
output OUTPUT_EVENTHUB_NAME string = 'output-events'
